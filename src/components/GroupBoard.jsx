...
import { GripVertical, Phone, ClipboardCheck, PlusCircle, Clock, ShieldAlert, Award, Heart, Cross, AlertTriangle, Lock, Unlock, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-600 transition-colors flex items-center"
                            title="Add Note"
                        >
                            <PlusCircle size={14} />
                            <span className="text-[10px] ml-0.5 font-medium">add note</span>
                        </button>
                    </div>
