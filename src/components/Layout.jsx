...
const Layout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="sticky top-4 z-50 w-full max-w-6xl mx-auto px-6 lg:px-12 mb-4 pointer-events-none">
                {/* Navigation - pointer-events-auto to enable interaction */}
                <nav className="glass-panel p-4 flex items-center justify-between shadow-lg pointer-events-auto">
            ...
            {/* Sub-Header Controls (Non-Sticky) */}
            {currentCampId && (
                <div className="w-full max-w-6xl mx-auto px-6 lg:px-12 mb-4 flex justify-end gap-2">
                    {currentCamp && (
                        <button
