...
import { ClipboardCheck, Users, Contact, Plus, Search, ChevronRight, Phone, LayoutGrid, CheckCircle2, XCircle, Lock, Unlock, Trash2, StickyNote } from 'lucide-react';
import ConfirmModal from '../components/ConfirmModal';
import AddAthleteModal from '../components/AddAthleteModal';
import GroupManager from '../components/GroupManager';
import GroupBoard from '../components/GroupBoard';
import AttendanceBoard from '../components/AttendanceBoard';
import DailyNotesBoard from '../components/DailyNotesBoard';
...
const CampDashboard = () => {
    ...
    const validTabs = ['attendance', 'groups', 'athletes', 'notes'];
